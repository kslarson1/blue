<?php
/**
 * Blue functions and definitions
 *
 * @package Blue
 */
...
function blue_setup() {
	 ...
	 * If you're building a theme based on Blue, use a find and replace
	 * to change 'blue' to the name of your theme in all the template files
	 */
	...
	add_theme_support( 'custom-background', apply_filters( 'blue_custom_background_args', array(
 ...
 */
function blue_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'blue' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'blue_widgets_init' );
...
function blue_scripts() {
	...
	wp_enqueue_script( 'blue-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
